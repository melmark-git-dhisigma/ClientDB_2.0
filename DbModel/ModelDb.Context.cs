...
namespace ClientDB.DbModel
{
    ...
    public partial class BiWeeklyRCPNewEntities : DbContext
    {
        ...
        public DbSet<BehaviorIOADetail> BehaviorIOADetails { get; set; }
        ...
        public virtual int BiweeklyReport_Trendline(Nullable<System.DateTime> startDate, Nullable<System.DateTime> eNDDate, Nullable<int> studentid, Nullable<int> schoolId, string lessonPlanid, string trendtype, string @event, string lPStatus, string clsType)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            var lPStatusParameter = lPStatus != null ?
                new ObjectParameter("LPStatus", lPStatus) :
                new ObjectParameter("LPStatus", typeof(string));
    
            var clsTypeParameter = clsType != null ?
                new ObjectParameter("ClsType", clsType) :
                new ObjectParameter("ClsType", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BiweeklyReport_Trendline", startDateParameter, eNDDateParameter, studentidParameter, schoolIdParameter, lessonPlanidParameter, trendtypeParameter, eventParameter, lPStatusParameter, clsTypeParameter);
        }
        ...
        public virtual int BiweeklyReport_Trendline_Set(Nullable<System.DateTime> startDate, Nullable<System.DateTime> eNDDate, Nullable<int> studentid, Nullable<int> schoolId, Nullable<int> lessonPlanid, string trendtype, string @event, string setIds, string dsTempSetColCalcIds, string isMaintanance, string lPStatus, string clsType)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BiweeklyReport_Trendline_Set", startDateParameter, eNDDateParameter, studentidParameter, schoolIdParameter, lessonPlanidParameter, trendtypeParameter, eventParameter, setIdsParameter, dsTempSetColCalcIdsParameter, isMaintananceParameter, lPStatusParameter, clsTypeParameter);
        }
        ...
        public virtual int BiweeklySessionReport(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> studentId, string lessonPlan, Nullable<int> schoolId, string @event, string trendType, string lPStatus, string includeIOA, string clsType)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            var includeIOAParameter = includeIOA != null ?
                new ObjectParameter("IncludeIOA", includeIOA) :
                new ObjectParameter("IncludeIOA", typeof(string));
    
            var clsTypeParameter = clsType != null ?
                new ObjectParameter("ClsType", clsType) :
                new ObjectParameter("ClsType", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BiweeklySessionReport", startDateParameter, endDateParameter, studentIdParameter, lessonPlanParameter, schoolIdParameter, eventParameter, trendTypeParameter, lPStatusParameter, includeIOAParameter, clsTypeParameter);
        }
        ...
        public virtual int IOABehaviorPercentage_Calculation(Nullable<int> measurmentId, Nullable<int> studentId, Nullable<int> behaviorIOAId, Nullable<int> normalBehavId, string status)
        {
            var measurmentIdParameter = measurmentId.HasValue ?
                new ObjectParameter("MeasurmentId", measurmentId) :
                new ObjectParameter("MeasurmentId", typeof(int));
    
            var studentIdParameter = studentId.HasValue ?
                new ObjectParameter("StudentId", studentId) :
                new ObjectParameter("StudentId", typeof(int));
    
            var behaviorIOAIdParameter = behaviorIOAId.HasValue ?
                new ObjectParameter("BehaviorIOAId", behaviorIOAId) :
                new ObjectParameter("BehaviorIOAId", typeof(int));
    
            var normalBehavIdParameter = normalBehavId.HasValue ?
                new ObjectParameter("NormalBehavId", normalBehavId) :
                new ObjectParameter("NormalBehavId", typeof(int));
    
            var statusParameter = status != null ?
                new ObjectParameter("Status", status) :
                new ObjectParameter("Status", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("IOABehaviorPercentage_Calculation", measurmentIdParameter, studentIdParameter, behaviorIOAIdParameter, normalBehavIdParameter, statusParameter);
        }
        ...
        public virtual int MaintenanceReport(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> schoolId, Nullable<int> studentId, string lessonHdrId, string setId, string events, string trendType, string includeIOA, string clsType)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            var lessonHdrIdParameter = lessonHdrId != null ?
                new ObjectParameter("LessonHdrId", lessonHdrId) :
                new ObjectParameter("LessonHdrId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MaintenanceReport", startDateParameter, endDateParameter, schoolIdParameter, studentIdParameter, lessonHdrIdParameter, setIdParameter, eventsParameter, trendTypeParameter, includeIOAParameter, clsTypeParameter);
        }
    
        public virtual int P1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P1");
        }
    
        public virtual int P2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P2");
        }
    
        public virtual int P3()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P3");
        }
    
        public virtual int P4()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P4");
        }
    
        public virtual int P5()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P5");
        }
    
        public virtual int ProgressSummaryReport(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> studentId)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ProgressSummaryReport", startDateParameter, endDateParameter, studentIdParameter);
        }
    
        public virtual int PSR_Data(Nullable<System.DateTime> startDate, Nullable<System.DateTime> eNDDate, Nullable<int> studentid, string lessonPlanId, string lPStatus)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PSR_Data", startDateParameter, eNDDateParameter, studentidParameter, lessonPlanIdParameter, lPStatusParameter);
        }
        ...
        public virtual int SessionScore_Calculation_Set1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SessionScore_Calculation_Set1");
        }
    
        public virtual int SessionScore_Calculation1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SessionScore_Calculation1");
        }
