        ...
        <tbody>
            ...
            <tr style="display: none">
                <td colspan="4" id="tdstudentName" class="nobdr" style="display: none;"><%=Model.LastName %> <%=Model.LastNameSuffix %>, <%=Model.FirstName %> <span style="color: <%=Color %>"><%= "("+Model.ClientStatus+")" %></span></td>
                        ...
                        <input id="btnDischarge" type="submit" value="Discharge" onClick="DischargeClient();" style="display:<%=DischBtnStatus %>;float:right;border:none;width:43px; height:43px;font-weight:bold;font-size:small;background-repeat:no-repeat;background-position:top left;margin-top:5px; margin-right: 5px; margin-bottom: 5px;"/>
    <input id="btnActivate" type="submit" value="Activate" onClick="ActivateClient();" style="display:<%=ActivateBtnStatus %>;float:right;border:none;width:43px; height:43px;font-weight:bold;font-size:small;background-repeat:no-repeat;background-position:top left;margin-top:5px; margin-right: 5px; margin-bottom: 5px;"/>
